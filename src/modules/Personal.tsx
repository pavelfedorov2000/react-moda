...
import ProfileNotify from '../components/ProfileNotify';

const filterProfilePersonalFields = (category: FieldCategory | ProfileData) => {
        ...
        <>
            <form className="profile-personal profile-page__form">
                <div className="profile-personal__item">
                    ...
                    <div className="profile-personal__row">
                        <div className="profile-personal__fields">
                            {filterProfilePersonalFields(FieldCategory.Personal)
                                .map((field) => {
                                    return {
                                        ...field,
                ...
                <div className="profile-personal__item">
                    ...
                    <div className="profile-personal__row">
                        <div className="profile-personal__fields">
                            {filterProfilePersonalFields(ProfileData.PHONE).map((field) => (
                    ...
                    <div className="profile-personal__row">
                        <div className="profile-personal__fields">
                            {filterProfilePersonalFields(ProfileData.EMAIL).map((field) => (
