...
import { AsideFilters, CatalogCard, CatalogFilters, CatalogView, CatalogCardPopup } from '../Components';
                  ...
                  <div class="catalog__cards">
                    {
                      favorites.map(product => (
                        <CatalogCard setVisibleCatalogCardPopup={setVisibleCatalogCardPopup} onClickAddFavorite={handleAddProductToFavorite} onClickRemoveFavorite={handleRemoveFavoriteProduct} key={product.id} {...product} />
                      ))}
                  </div>
                }
              </div>
