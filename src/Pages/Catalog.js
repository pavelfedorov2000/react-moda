...
function Catalog() {
  ...
  return (
    <>
      ...
      {
        products.map(product => <CatalogCardPopup key={product.id} {...product} favorite={favorite} toggleFavorite={toggleFavorite} onClickAddFavorite={handleAddProductToFavorite} />)
      }
    </>
  );
}
