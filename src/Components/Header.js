...
function Header({ categories, activeCategory, onChangeCategory, phone, onAsideBasketOpener, onAsideAuthOpener }) {
                ...
                <div className="container header__top-inner">
                    ...
                    <div className="header__contact">
                        ...
                        <a href="https://wa.me/" className="header__whatsup" target="_blank" rel="nofollow">
                            <img className="header__whatsup-icon" src={whatsup} alt="whatsup" width="16" height="16" />
                            WhatsApp
                        </a>
                    </div>
                </div>
