...
const Pagination = ({ align }: { align?: string; }) => {
    return (
        <nav className={classNames(mainClass, align, {
            [`${mainClass}--align_${align}`]: align
        })} aria-label="Пагинация">
            <button className={`${mainClass}__arrow`}>
            ...
            <ol className={`${mainClass}__list`}>
                ...
                <li className={`${mainClass}__item`}>
                    <button className={`${mainClass}__link`}>2</button>
                </li>
                <li className={`${mainClass}__item`}>
                    <button className={`${mainClass}__link`}>3</button>
                </li>
                <li className={`${mainClass}__item`}>
                    <button className={`${mainClass}__link`}>4</button>
                </li>
            </ol>
            <button className={`${mainClass}__arrow`}>
                <svg viewBox="0 0 56 16" fill="none" xmlns="http://www.w3.org/2000/svg">
