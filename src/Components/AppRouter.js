...
function AppRouter() {
    const routes = React.useMemo(() => [{
        ...
        path: "/not-found",
        component: NotFound
    }], [Home, CatalogHome, Catalog, Cart, ProductCard, Favorite, Brands, NotFound, OrderSuccess, Blog, BlogDetail, News, NewsDetail, Profile, Discounts, MyOrders, OrderDetail, Personal, Subscribes, emptyProducts, emptyBlog]);
