...
function ShopsSearch() {
  return (
    <a className="shops-search header__shops-search" href="#">
      <svg className="shops-search__icon" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <span className="shops-search__text">Найти магазины</span>
    </a>
  );
}
