...
function BasketProduct({ id, articul, name, brand, sizes, price, imageUrl, color, discount, onRemoveItem }) {
        ...
        <div className="basket-product drop-basket__product">
            ...
            <div className="drop-basket__product-wrap">
                ...
                <div className="basket-product__prices-wrap drop-basket__product-prices">
                    {discount != undefined &&
                        <div className="price old-price basket-product__old-price">{`${Math.floor(price * 100 / (100 - discount))} ₽`}</div>
                    }
