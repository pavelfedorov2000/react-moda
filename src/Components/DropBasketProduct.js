...
function DropBasketProduct({ id, articul, name, brand, size, imageUrl, color, discount, onRemoveItem, onPlusItem, onMinusItem, totalCount, totalPrice, setBasketProduct }) {
