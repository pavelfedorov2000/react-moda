      ...
      {activeSelect &&
        <div className="select__content">
          {options.map((option, i) => (
            <SubscribeOption key={option} onClickChangeSubscribe={onClickChangeSubscribe} checkedSubscribeSelect={checkedSubscribeSelect} onCheckSubscribeSelect={onCheckSubscribeSelect} subscribes={subscribes} option={option} item={item} i={i} obj={obj} />
          ))}
        </div>
      }
    </div>
