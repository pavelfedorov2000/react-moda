        ...
        <button
            ...
            {icon &&
                <>
                        ...
                        {favorite &&
                            <>
                                {isFavoriteProduct ?
                                    <>
                                        {transparent ?
                                            <svg className="icon favorite icon--size_xs" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <svg className="icon favorite" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                    ...
                    <>
                        {remove &&
                            <svg className="icon icon--size_xs" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.8">
                                    <path fillRule='evenodd' clipRule='evenodd'
