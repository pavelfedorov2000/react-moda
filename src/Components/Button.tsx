        ...
        <button
            ...
            {icon &&
                <>
                        ...
                        {favorite &&
                            <>
                                {isFavoriteProduct ?
                                    <>
                                        {transparent ?
                                            <svg className="icon favorite" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <>
                        {remove &&
                            <svg className="icon" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.8">
                                    <path fillRule='evenodd' clipRule='evenodd'
