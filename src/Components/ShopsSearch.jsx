...
function ShopsSearch() {
    return (
        <a className="action-header header__shops-search" href="#">
            <svg className="action-header__icon" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_611_26879)">
            ...
            <span className="action-header__text">Найти магазины</span>
        </a>
    );
}
