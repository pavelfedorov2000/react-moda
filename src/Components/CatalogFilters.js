...
function CatalogFilters({ onClickSort, activeSortBy, sortFilters, sortPrices, onChangePrices, onResetPrices, onSelectSortColors }) {

    /* const toggleCheckbox = () => {
      setChecked(!checked);
    } */
    const [checkedFilters, setCheckedFilters] = useState([]);
    const onCheckChange = (arr, index) => {

        //toggleCheckbox();
        let checkText = arr[index].name;
        let copy;
        if (!checkedFilters.includes(checkText)) {
            copy = [...checkedFilters];
            copy.push(checkText);
        } else {
            copy = [...checkedFilters];
    ...
    return (
        <form action="#" class="catalog-filters">
            ...
            <div class="catalog-filters__row">
                ...
                <Color onCheckChange={onCheckChange} checkedFilters={checkedFilters} onSelectSortColors={onSelectSortColors} />
                <Size />
