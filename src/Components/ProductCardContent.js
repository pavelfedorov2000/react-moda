        ...
        <div className="product-card__content">
            ...
            <form action="#" className="product-card-form">
                ...
                <div className="product-card-form__buttons">
                    <button onClick={onAddProductToCart} className="btn product-card-form__btn product-cart-btn" type="button" style={{ backgroundColor: `${isBasketProduct ? '#479458' : '#ee3333'}` }}>
