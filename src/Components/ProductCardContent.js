...
import { ProductSizes, ProductColor } from '../Components';

function ProductCardContent({ setFavorite, onClickAddFavorite, onClickRemoveFavorite, onAddCart, id, articul, name, brand, sizes, color, price, imageUrl, discount, newProduct }) {
    ...
    return (
        <div className="product-card__content">
            <div className="product-card__top-wrap">
                ...
                <img className="product-card__logo" src="assets/images/logo/loriata.png" alt="логотип Loriata" width="76" height="38" />
            </div>
            ...
            <section className="product-card__section product-card-delivery">
                ...
                <div className="product-card-delivery__row">
                    <div className="product-card-delivery__item">
                        <img className="product-card-delivery__item-img" src="assets/images/icons/delivery-issue.svg"
                    ...
                    <div className="product-card-delivery__item">
                        <img className="product-card-delivery__item-img" src="assets/images/icons/truck.svg"
