...
function Color({ onCheckChange, checkedFilters, onSelectSortColors }) {
            ...
            {visibleFilter &&
                <div className="catalog-filters__item-drop catalog-drop-filter">
                            ...
                            <div className="catalog-drop-filter__items">
                                {colors.map((color, i) => (
                                    <label key={color.id} className="catalog-drop-filter__item">
                                        <input onChange={() => onCheckChange(colors, i)} className="check-box" type="checkbox" name="color" />
                    ...
                    <div className="catalog-drop-filter__buttons">
                        ...
                        <button onClick={() => onSelectSortColors(checkedFilters)} className="btn catalog-drop-filter__btn" type="button">Применить</button>
                    </div>
                </div>
            }
        </fieldset >
