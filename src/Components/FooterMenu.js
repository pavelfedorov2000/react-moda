                ...
                <div key={col.name} className="footer__col">
                    ...
                    <ul className="footer__list">
                        {col.items.map((item, j) => (
                            <li key={item.link.href ? item.link.href : `/${col.name}_${j}`} className="footer__list-item">
                                <Link to={item.link.href ? item.link.href : `/${col.name}`} className="footer__list-link">{item.link.text}</Link>
                            </li>
                        ))}
                    </ul>
