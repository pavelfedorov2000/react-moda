            ...
            <>
              <div className="drop-basket__products">
                {addedProducts.map(product => (
                  <DropBasketProduct key={product.id} {...product} onRemoveItem={onRemoveItem} onMinusItem={onMinusItem} onPlusItem={onPlusItem} totalPrice={items[product.id].totalPrice} totalCount={items[product.id].items.length} setBasketProduct={setBasketProduct} />
                ))}
              </div>
