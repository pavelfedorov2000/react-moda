    ...
    <form action="#" className="aside-popup__form">
      ...
      <label className="form-agree aside-popup__form-wrap">
        ...
        <span className="check-text">
          Подтверждаю согласие с <Link to="/not-found">Политикой конфиденциальности</Link> и <Link to="/not-found">Правилами работы интернет-магазина</Link>, а также даю согласие на
          <Link to="/not-found">обработку персональных данных</Link>
        </span>
      </label>
