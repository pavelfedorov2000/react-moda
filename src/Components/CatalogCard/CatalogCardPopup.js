    ...
    <div ref={catalogPopupRef} className="popup product-popup">
      ...
      <div className="product-popup__inner">
        <Swiper {...params} className="product-popup__slider">
          {[0, 1, 2].map(slide => (
            <SwiperSlide key={slide} className="product-popup__slider-item">
              <img src={imageUrl} alt="фото" width="464" height="590" />
            </SwiperSlide>
          ))}
          <div class="swiper-pagination"></div>
          <div class="swiper-button-prev product-popup__slider-arrow product-popup__slider-arrow--prev">
          ...
          <div class="swiper-button-next product-popup__slider-arrow product-popup__slider-arrow--next">
            <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <form className="product-popup__form product-card-form">
            ...
            <div className="product-card-form__buttons">
              ...
              <button onClick={onAddFavoriteProduct} className="btn product-card-form__btn product-favorite-btn btn--border" type="button">
                ...
                <span>{`В избранно${favorite ? 'м' : 'е'}`}</span>
              </button>
            </div>
          </form>
