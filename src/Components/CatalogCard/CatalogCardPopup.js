...
function CatalogCardPopup({ id, name, brand, sizes, price, imageUrl, discount, newProduct, favorite, toggleFavorite }) {
  const productList = {
    "Сезон": "Демисезон",
    "Материал": "Альпака",
        ...
        <div className="product-popup__content">
          ...
          <form className="product-popup__form product-card-form">
            ...
            <div className="product-card-form__buttons">
              ...
              <button onClick={toggleFavorite} className="btn product-card-form__btn product-favorite-btn btn--border" type="button">
                {favorite ?
