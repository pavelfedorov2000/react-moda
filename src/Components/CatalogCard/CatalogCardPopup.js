    ...
    return (
        <div style={{ display: 'none' }} id="product-popup" className="popup product-popup">
            <div className="product-popup__inner">
                <img className="product-popup__slider" src={productImage} alt="фото" width="464" height="590" />
                ...
                <Link to="/product-card" className="product-popup__more-link">
