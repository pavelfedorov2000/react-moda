...
import productImage from '../../assets/images/content/product-popup-woman.jpg';

function CatalogCardPopup(props) {
  const productList = {
    "Сезон": "Демисезон",
    "Материал": "Альпака",
  ...
  return (
    <div style="display: none;" id="product-popup" className="popup product-popup">
      <div className="product-popup__inner">
        <Swiper {...params} className="product-popup__slider">
          {[1, 2, 3].map((slide, i) => (
            <SwiperSlide key={`slide-${i + 1}`} className="product-popup__slider-item">
              <img src={productImage} alt="фото" width="464" height="590" />
            </SwiperSlide>
          ))}
        </Swiper>
        ...
        <div className="product-popup__content">
          <div className="product-popup__content-top">
            <div className="product-popup__title">Пальто LORIATA Wander Yellow</div>
            <div className="prices">
              <div className="old-price product-popup__old-price">47 800 ₽</div>
              <div className="new-price">38 240 ₽</div>
            </div>
          </div>
          <form action="#" className="product-popup__form product-card-form">
            ...
            <div className="product-card-form__buttons">
              ...
              <button className="btn product-card-form__btn product-favorite-btn btn--border" type="button">
                ...
                <span className="favorite">В избранном</span>
              </button>
            </div>
          </form>
          <div className="about-product product-popup__about">
            <h4 className="about-product__title">О товаре</h4>
            ...
            <a href="#" className="popup-link">Подробнее</a>
          </div>
          @@("blocks/product-links/product-links.html")
        </div>
        <a href="#" className="product-popup__more-link">
