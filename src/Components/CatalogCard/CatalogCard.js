...
function CatalogCard({ id, name, brand, imageUrl, price, color, sizes, isFavorite, discount, newProduct, favorite, toggleFavorite, onClickAddFavorite, setVisibleCatalogCardPopup }) {
    /* if (isLoaded) {
        return <PizzaLoader />;
    } */
